...
public class FifthTypeGroup extends AbstractGroup {
    private static final GroupType TYPE = GroupType.FIFTH;

    public FifthTypeGroup() {
    }

    public FifthTypeGroup(final String name) {
        setName(name);
    }
