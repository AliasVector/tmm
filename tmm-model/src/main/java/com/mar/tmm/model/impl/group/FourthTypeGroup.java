...
public class FourthTypeGroup extends AbstractGroup {
    private static final GroupType TYPE = GroupType.FOURTH;

    public FourthTypeGroup() {
    }

    public FourthTypeGroup(final String name) {
        setName(name);
    }
